        ...
        <div class="carousel-inner h-100 " role="listbox">
            <div class="carousel-item active back-0 h-100 align-items-center justify-content-center">
                <div class="jumbotron w-50 h-50">
                    ...
                    <hr>
                    <p class="h-50">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
        ...
        <div class="col-4 align-items-center justify-content-center m-2">
            ...
            <div class="card" style="width: 100%; background-color:rgba(10,0 ,0 , 0.7);">
                ...
                <div class="card-block">
                    <h4 class="card-title text-white"><%=LoggedInUser.getName() %>
                    </h4>
                    <p class="card-text text-info"><%=LoggedInUser.getEmail()%>
                    </p>
                </div>
                <div class="card-block ">
                    <%--@TODO Modal Change Password--%>
                    <%--@TODO AJAX GetNumber of messages--%>
                    <button class="btn btn-info btn-large " data-toggle="modal" data-target="#ChangePassword">Change
                        password
                    </button>


                    <a class="card-link text-danger " href="/ShowMessages.jsp">Show Messages <span id="msgNum"

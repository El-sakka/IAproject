...
<div class="container">
    <div class="jumbotron">
        <form action="/ReportFormCtl" method="post">
            <div class=" row ">
            ...
            <div class="form-group">
                <label for="report-text">Enter the message</label>
                <textarea class="form-control" id="report-text" name="report-text" rows="5"></textarea>
            </div>
            <hr>
            <input type="submit" class="btn btn-danger float-right" value="Report"/>
        </form>
    </div>
</div>
<!-- Footer -->

...
public class AnswerModel {
    ...
    public Answer addAnswer(String answerText, int questionID) {
        ...
        try{
            ...
            answer = new Answer(getLastID(), answerText, questionID);
            //close connection
            conn.close();
        }catch (Exception e){
    ...
    public Answer geAnswer(int ID) {
        ...
        try {
            ...
            if (rs.next()) {//get the Next (if exists)
                ...
                answer = new Answer(rs.getInt("ID"), rs.getString("answerText"), rs.getInt("questionID"));
            }

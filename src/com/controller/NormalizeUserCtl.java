...
@WebServlet(name = "NormalizeUserCtl")
public class NormalizeUserCtl extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // @Question : can Admin Normalize Another Admin ? (yes assumed)
        if (admin.getType().equalsIgnoreCase("admin")) {
            //Normalize User
            userModel.NormalizeUser(userName);
        }
        //redirect Client to home Page
        response.sendRedirect("/index.jsp");
        //That's all! Done!! Enjoy ;)
